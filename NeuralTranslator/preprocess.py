...
"""
# -data_type img -src_dir data_full/im2text/images/ -train_src data_full/im2text/src-train.txt -train_tgt data_full/im2text/tgt-train.txt -valid_src data_full/im2text/src-val.txt -valid_tgt data_full/im2text/tgt-val.txt -save_data data_full/im2text/demo -tgt_seq_length 150 -tgt_words_min_frequency 2 -shard_size 500 -image_channel_size 1
# -train_src data_trans/src-train.txt -train_tgt data_trans/tgt-train.txt -valid_src data_trans/src-val.txt -valid_tgt data_trans/tgt-val.txt -save_data data_trans/demo
