# -data_type img -src_dir data/images/ -train_src data/src-train.txt -train_tgt data/tgt-train.txt -valid_src data/src-val.txt -valid_tgt data/tgt-val.txt -save_data data/demo -tgt_seq_length 3 -tgt_words_min_frequency 2 -shard_size 500 -image_channel_size 1
#!/usr/bin/env python
# -*- coding: utf-8 -*-
"""
